...
function makeDelivererIcon(photoUrl: string | null | undefined, name: string | null | undefined): L.DivIcon {
...
export function TrackingMap({
  ...
  useEffect(() => {
    ...
    if (destinationLat != null && destinationLng != null) {
      ...
      lineRef.current = L.polyline(line, { color: GREEN, weight: 4, opacity: 0.7 }).addTo(map);
