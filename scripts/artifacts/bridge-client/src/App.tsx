  ...
  },
  {
    ...
    categories:[
      ...
      { id:'salads', emoji:'🥗', names:{fr:'Salades',en:'Salads',ar:'سلطات',amz:'ⵜⵓⴼⴽⵉⵡⵉⵏ'}, items:[
        {id:'bsl1',names:{fr:'Salade César',en:'Caesar Salad',ar:'سلطة سيزر',amz:'ⵙⵉ��ⴰⵔ'},price:30,photo:'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&q=80'},
